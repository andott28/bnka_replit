      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-16">
            <Card className="text-center p-4 hover:shadow-lg transition-shadow h-full flex flex-col dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="pt-4 px-2 flex flex-col flex-grow">
                <FileCheck className="h-12 w-12 mx-auto mb-4 text-primary" />
                <h3 className="font-semibold mb-2 dark:text-white">Personlig kredittscore</h3>
            ...
            <Card className="text-center p-4 hover:shadow-lg transition-shadow h-full flex flex-col dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="pt-4 px-2 flex flex-col flex-grow">
                ...
                <h3 className="font-semibold mb-2 dark:text-white">Forbedringsanalyse</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 break-words">
            ...
            <Card className="text-center p-4 hover:shadow-lg transition-shadow h-full flex flex-col dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="pt-4 px-2 flex flex-col flex-grow">
                ...
                <h3 className="font-semibold mb-2 dark:text-white">Lånemuligheter</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 break-words">
            ...
            <Card className="text-center p-4 hover:shadow-lg transition-shadow h-full flex flex-col dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="pt-4 px-2 flex flex-col flex-grow">
                ...
                <h3 className="font-semibold mb-2 dark:text-white">Kontinuerlig overvåking</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 break-words">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-4 mb-12">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-medium mb-1 dark:text-white">Opprett konto</h3>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-medium mb-1 dark:text-white">Verifisering</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-medium mb-1 dark:text-white">AI-analyse</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Vi analyserer din finansielle profil</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="bg-primary text-white rounded-full w-10 h-10 flex items-center justify-center mb-3">
                  4
                </div>
                <h3 className="font-medium mb-1 dark:text-white">Resultater</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="mb-16">
            ...
            <Accordion type="single" collapsible className="w-full dark:text-gray-200">
              <AccordionItem value="item-1" className="dark:border-gray-700">
                <AccordionTrigger className="dark:text-gray-200">Hva er en kredittscore?</AccordionTrigger>
              ...
              <AccordionItem value="item-2" className="dark:border-gray-700">
                <AccordionTrigger className="dark:text-gray-200">Hvordan beregnes min kredittscore hos Styr AS?</AccordionTrigger>
                <AccordionContent className="dark:text-gray-300">
